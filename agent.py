...
class Agent2:
    def __init__(
        ...
        self.__path = "./models/test3.pth"
        self.__load = load

        self.__policy_net = Net1(
            size_board * size_board, hidden_dim_1, hidden_dim_2, hidden_dim_3,  output_dim
        )
        self.__policy_net.train()

        self.__target_net = Net1(
            size_board * size_board, hidden_dim_1, hidden_dim_2, hidden_dim_3, output_dim
        )
        ...
        # Optimizer
        self.__optimizer = optim.Adam(self.__policy_net.parameters(), lr=learning_rate)
        self.scheduler = StepLR(self.__optimizer, step_size=30, gamma=0.05)
    ...
    def load_model(self):
        ...
        self.__policy_net.load_state_dict(torch.load(self.__path))
        # self.__policy_net.to(device)